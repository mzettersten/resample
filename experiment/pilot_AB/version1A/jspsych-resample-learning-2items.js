...
jsPsych.plugins['resample-learning-2items'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
	...
	//function to play audio
	  ...
	  var standardTalk = s.image(trial.standardImTalk,311,38,179,258);
	  var standardBack = s.image(trial.standardIm,311,38,179,258);
	  var standard2 = s.image(trial.standardIm2,288,0,230,210);
	  var standard = s.image(trial.standardIm,311,38,179,258);
